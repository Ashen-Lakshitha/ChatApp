...
public class Client_2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(668, 551));
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
        try {
            ...
            if(!"".equals(msg)){
                ...
                String st = "Client_2 : " + msg;
                dout.writeUTF(st);
                InsertMsg in = new InsertMsg();
                in.addMsg(msg,"Client_2");
            }
            ...
            try{
                ...
                for(String str:list){
                    if(str.startsWith("Client_2:")){
                        str = str.replace("Client_2:", "You\t: ");
                    }
                    if(str.startsWith("Client_1:")){
                        str = str.replace("Client_1:", "Client_1\t: ");
                    }
                    label.append(str + "\n");
                ...
                while (true) { 
                    ...
                    if(string.startsWith("Client_2 : ")){
                        string = string.replace("Client_2 : ", "You\t: ");
                    }
                    if(string.startsWith("Client_1 : ")){
                        string = string.replace("Client_1 : ", "Client_1\t: ");
                    }
